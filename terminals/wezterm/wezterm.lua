...
elseif is_linux or is_darwin then
    config.launch_menu = {
        ...
        {
            label = 'Fish(linuxbrew)',
            args = { '/home/linuxbrew/.linuxbrew/bin/fish', '-i', '-l' },
        },
        {
            label = 'Zsh',
            args = { 'zsh', '-i', '-l' },
        ...
        {
            label = 'Zsh(linuxbrew)',
            args = { '/home/linuxbrew/.linuxbrew/bin/zsh', '-i', '-l' },
        },
        {
            label = 'PowerShell Core',
            args = { 'pwsh' },
        ...
        {
            label = 'PowerShell Core(linuxbrew)',
            args = { '/home/linuxbrew/.linuxbrew/bin/pwsh' },
        },
        {
            label = 'Nushell',
            args = { 'nu' },
    ...
    -- 设置Unix系统默认shell
    if is_darwin then
        config.default_prog = { 'zsh', '-i', '-l' }  -- macOS默认使用zsh
    else
        config.default_prog = { 'bash', '-i', '-l' } -- Linux默认使用bash
    end
end
